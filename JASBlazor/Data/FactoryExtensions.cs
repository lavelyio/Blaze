...
namespace JASBlazor.Data
{
    ...
    public static class FactoryExtensions
    {
        ...
        /// Optional access to the <see cref="DbContextOptions{TContext}" />.
        /// </param>
        /// <param name="contextAndOptionsLifetime">
        /// Set the <see cref="ServiceLifetime" /> of the factory and options.
        /// </param>
        ...
        public static async Task<List<TResult>> ToListAsync<TContext, TResult>(
        ...
        /// <summary>
        /// This is NOT for production use. This extension method creates and populates the database
        /// for the first time to make the sample easiser to run. In production scenarios it could
        ...
        public static async Task EnsureDbCreatedAndSeedWithCountOfAsync(this DbContextOptions<JASDBContext> options, int count)
        {
            var builder = new DbContextOptionsBuilder<JASDBContext>(options);
            builder.UseLoggerFactory(new LoggerFactory());
            using var context = new JASDBContext(builder.Options);
